...
import org.company.firestorm.client.local.convert.RelativeTimeConverter;
import org.company.firestorm.client.local.convert.UsernameConverter;
...
@Dependent
@Templated("#main")
public class FooItemWidget extends Composite implements HasModel<Item> {
